<template>
  <div class="product-image-area">
    ...
    <ProgressiveImage :placeholder-src="image1 + placeholderParams" :src="image1" alt="演示图片" :width="500"
      :height="300" />
    <ProgressiveImage :placeholder-src="image2 + placeholderParams" :src="image2" alt="演示图片" :width="200"
      :height="200" />
  </div>
</template>
...
const placeholderParams = '?x-oss-process=image/resize,w_50/quality,q_10'
</script>
